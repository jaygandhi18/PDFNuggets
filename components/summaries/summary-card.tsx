        ...
        <span
            className={cn(
                ...
                status === 'completed'
                    ...
                    : 'bg-yellow-100 text-yellow-800'  // Keeping yellow for warning/pending statuses if desired, else can change to another teal shade
            )}
        >
            {status}
        </span>
...
export default function SummaryCard({ summary }: { summary: any }) {
    return (
        <MotionDiv variants={itemVariants} initial="hidden" animate="visible" whileHover={{
            scale: 1.02,
